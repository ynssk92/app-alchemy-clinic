        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="mt-8 text-lg text-slate-500 leading-relaxed mb-10">
              We combine professional excellence with a deeply human approach, ensuring that your journey to a better smile is as comfortable as it is effective.
            </p>
