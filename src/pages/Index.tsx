      ...
      <section id="home" className="relative overflow-hidden scroll-mt-20">
        ...
        <div className="container mx-auto px-4 py-24 md:py-32 relative">
          <div className="max-w-2xl">
            <span className="reveal inline-block text-xs font-bold tracking-[0.2em] uppercase text-primary mb-4">
              La Dune Clinique Dentaire
            </span>
            <h1 className="reveal text-5xl md:text-7xl font-bold text-foreground mb-6 leading-[1.05]" style={{ transitionDelay: "80ms" }}>
              Rencontrez nos{" "}
              <span className="bg-gradient-primary bg-clip-text text-transparent">meilleurs praticiens</span>
            </h1>
            <p className="reveal text-lg md:text-xl text-muted-foreground mb-8 max-w-xl" style={{ transitionDelay: "160ms" }}>
